...
from Modules import Button, PlainTextEdit, Key, Group, ErrorType
...
class AESWidget(CryptographyWidget):
    ...
    def set_up_key(self, key):
        ...
        self.logging.log("Key: {}".format(private_key.decode('utf-8')))
        self.widgets_dict["Key"].set_text(private_key.decode('utf-8'))
