...
from core.algorithms.hash.SHA256 import Thread as SHA256
...
class SHA256Widget(CryptographyWidget):
    def __init__(self):
        ...
        self.setWindowTitle("SHA-256")        self.groups_config = [
        ...
        self.render()
        self.log_message("SHA-256 algorithm has been imported.\n")
    ...
    def computer_hash(self):
        try:
            ...
            if message_len == 0:
                self.log_message(ErrorType.LengthError.value + "The message length cannot be 0.\n")
