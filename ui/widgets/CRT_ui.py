...
class CRTWidget(CryptographyWidget):
    def __init__(self):
        ...
        self.render()
        self.log_message("Chinese remainder theorem has been imported.\n")

    def func(self, str_data: str):
        self.log_message("Answer is: " + str_data)
    ...
    def solve(self):
        try:
            ...
            self.log_message("Perform Chinese remainder theorem on your computer.")
            ...
            if Euclidean.Thread.gcd(m3, m1) != 1:
                ...
                self.pop_message_box(ErrorType.NotMeetRequirementError.value)
                return
            self.log_message("a1:  " + a1)
            self.log_message("a2:  " + a2)
            self.log_message("a3:  " + a3)
            self.log_message("m1:  " + str(m1))
            self.log_message("m2:  " + str(m2))
            self.log_message("m3:  " + str(m3))
            a1 = int(a1)
            a2 = int(a2)
            a3 = int(a3)
