...
class CryptoOperation(metaclass=abc.ABCMeta):
    ...
    key_class = key.PublicKey  # type: #typing.Type[mm_rsa.key.AbstractKey]

    def __init__(self) -> None:
        self.usage %= self.__class__.__dict__
        self.input_help %= self.__class__.__dict__
        self.output_help %= self.__class__.__dict__

    @abc.abstractmethod
    def perform_operation(self, indata: bytes, key: key.AbstractKey,
                          cli_args: Indexable):
...
class EncryptOperation(CryptoOperation):
    ...
    def perform_operation(self, indata: bytes, pub_key: key.AbstractKey,
                          cli_args: Indexable = ()):
        """Encrypts files."""
...
class DecryptOperation(CryptoOperation):
    ...
    def perform_operation(self, indata: bytes, priv_key: key.AbstractKey,
                          cli_args: Indexable = ()):
        """Decrypts files."""
